...
<!--        <link type="text/css" rel="stylesheet" href="CSS_INTERNO/csspantalla.css" />-->
        ...
        <script type="text/javascript" src="new_js/Ganancia.js" ></script>
                            ...
                            <div id="content" >
                                ...
                                <div class="column full fl">
                                    <div class="box tabs themed_box">
                                        <h2 class="box-header">GANANCIAS </h2>
                                          <ul class="tabs-nav">
                                        ...
                                        <div class="box-content">  
											...
											<div id="dialg_form" class="dialog" title="SYSFACTURA INFORMA">   
												...
												<form id="frmGanancia_Update" method="post" action="">
													...
													<input id="update_porctj_ganancia" class="form-field width40" name="update_porctj_ganancia" type="text" value="" maxlength="100"/>
													
													<label class="form-label required"> Descripción </label>
													<input id="update_descrip_ganancia" class="form-field width80" name="update_descrip_ganancia" type="text" value="" maxlength="100"/>
													<hr/>
													<p class="fr">
													<input id="btn_Ganancia_Cancelar" class="button themed" type="submit" value="Cancelar" name="btn_Ganancia_Cancelar" />
													<input id="btn_Ganancia_Update" class="button themed" type="submit" value="Actualizar" name="btn_Ganancia_Update" />
													</p>
												</form>
											</div>
											...
											<div id="tabs-2">
												<form id="frmGanancia_Add" method="post" action="">
													<label class="form-label required"> Porcentaje de Ganancia </label>
													<input id="save_porctj_ganancia" class="form-field width40" name="save_porctj_ganancia" type="text" value="" maxlength="100"/>
                                                    <label class="form-label required"> Descripción </label>
													<input id="save_descrip_ganancia" class="form-field width60" name="save_descrip_ganancia" type="text" value="" maxlength="100"/>
                                                    <p>
													<input id="btn_Ganancia_New" class="button themed" type="submit" value="Nuevo" name="btn_Ganancia_New" />
													<input id="validate" class="button themed" type="submit" value="Guardar" name="btn_Ganancia_Add" />
                                                    </p>
                                                </form>
											</div>
