...
-->                                                                    
                                                                ...
                                                                <tr >
                                                                    <td colspan="2">
                                                                        ...
                                                                        name="update_obs_persona" type="text" value="" maxlength="255"/>
                                                                    </td>
                                                                </tr>
...
-->                                                               
				                    ...
				                    <input id="btn_Persona_Cancel" class="button themed" type="button" 
                                            ...
                                            <div id="tabs-1">
                                                  <div id="tabla_result">
                                                       <table id="table-modificar" cellpadding="0" cellspacing="0" border="0" class="display" >
																																						<thead>
																																								<tr>
		                                                            <th>ID</th>
		                                                            <th>Razón Social</th>
...
<!--                                                                        <label class="form-label required"> Estado Civil </label>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        name="save_ruc_persona" type="text" value="" maxlength="11"/>
                                                                    </td>
                                                                    <td>
                                                                       <label class="form-label required"> Ciudad </label>
...
<!--                                                                        <label class="form-label required"> Sitio Web</label>
                                                                ...
                                                                <tr >
                                                                    <td colspan="2">
                                                                        ...
                                                                        name="save_obs_persona" type="text" value="" maxlength="255"/>
                                                                    </td>
                                                                </tr>
<!--                                                                
                                                                <tr>
