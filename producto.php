...
<?php 
 ...
 include_once 'MODEL/Tiporetencion.php';
 include_once 'MODEL/Marca_producto.php';
 include_once 'MODEL/Unidad_medida.php';
 include_once 'MODEL/Ganancia.php';
...
<!--        <link type="text/css" rel="stylesheet" href="CSS_INTERNO/csspantalla.css" />-->
        ...
        <script type="text/javascript" src="new_js/Producto.js" ></script>
...
-->
                                            ...
                                            <div id="tabs-2">                                              
                                                 <form id="frmProducto_Add" method="post" action="">
                                                  <input type="hidden" id="save_cambio_fecha" name="save_cambio_fecha" value="0"/>
                                                  <table border="0"  width="880" cellspacing="80">
                                                        ...
                                                        <tbody>                                                           
                                                                <tr>
                                                                    <td >
                                                                        <label class="form-label required"> Código </label>
                                                                         <input id="save_nom_producto" class="form-field width40" name="save_nom_producto" type="text" value="" maxlength="100"/>
                                                                    </td>   
                                                                    <td>
                                                                        <label class="form-label required"> Proveedor </label>
                                                                        <div id="div_proveedor" class="ui-helper-clearfix"> 
                                                                         <input id="save_tipo_proveedor" class="form-field width20" name="save_tipo_proveedor" type="text" />
                                                                         </div>
                                                                    </td>
                                                                </tr>                                                         
                                                                ...
                                                                <tr>
                                                                    <td >
                                                                       ...
                                                                       <input id="save_descrip_producto" class="form-field width60" name="save_descrip_producto" type="text" value="" maxlength="200"/>
                                                                    </td>
																	<td>
                                                                        <label class="form-label required"> Tipo </label>
																		<select id="save_tipo" name="save_tipo" class="form-field width40">
                                                                             <option value="comerciable">Comerciable</option>
																			 <option value="insumo">insumo</option>
                                                                        </select> 
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <label class="form-label required"> Código de Barra </label>
                                                                        <input id="save_codbarra_producto" class="form-field width60" name="save_codbarra_producto" type="text" value="" maxlength="50"/>  
                                                                    </td>
                                                                    <td>
                                                                        <label class="form-label required">Marca</label>
                                                                ...
                                                                <tr>
                                                                			<td>
                                                                        <label class="form-label required"> Tipo de IVA </label>
                                                                          <select id="save_id_tipoiva" name="save_id_tipoiva" class="form-field width40">
                                                                            <?php foreach($arr_tipoiva as $tipoiva){?>
                                                                              <option value="<?php echo $tipoiva->get_id_tipoiva()?>"><?php  $dat=$tipoiva->get_nom_tipoiva();$dat=$dat.' -> '.$tipoiva->get_porcentaje_iva();echo $dat;?></option>
                                                                              <?php } ?>
                                                                        </select> 
...
-->
                                                                ...
                                                                <tr>
																	...
																	<td colspan>
                                                                        <label class="form-label required"> Posición </label>
                                                                        <input id="save_posicion_producto" name="save_posicion_producto" class="form-field width40" type="text" value=""/>
                                                                    </td> 
                                                                ...
                                                                <tr>
																	<td >
                                                                         <label class="form-label required"> Stock Mínimo </label>
                                                                          <input id="save_stkmin_producto" class="form-field width40" name="save_stkmin_producto" type="text" value="" maxlength="10"/>
                                                                    </td>
                                                                    <td >
                                                                         <label class="form-label required"> Stock Máximo </label>
                                                                          <input id="save_stkmax_producto" class="form-field width40" name="save_stkmax_producto" type="text" value="" maxlength="10"/>
                                                                    </td>
																...
																<tr>
																	<td >
                                                                         <label class="form-label required"> Stock Actual </label>
                                                                          <input id="save_stkactual_producto" class="form-field width40" name="save_stkactual_producto" type="text" value="" maxlength="10"/>
                                                                    </td>
                                                                ...
                                                                <tr >
                                                                    ...
                                                                    <td >
                                                                        <label class="form-label required"> Fecha de actualización </label>
                                                                          <input id="save_fecupdate_producto" name="save_fecupdate_producto" class="form-field datepicker" type="text"/>
...
-->
                                            ...
                                            <div id="tabs-3">
                                            	<form id="frmProducto_Buscar_Delete" method="post" action="">
                                             		...
                                             		<input id="txt_Buscar_Delete" class="form-field width40" name="txt_Buscar_Delete" type="text" value="" maxlength="10"/>
                                              		<input id="btn_Producto_Buscar_Delete" class="button themed" type="submit" value="Buscar" name="btn_Producto_Buscar_Delete" />
                                             	</form>
                                            ...
                                            <div id="tabs-4">  
                                            	<form id="frmProducto_aumento" method="post" action="">
                                            		<table border="0"  width="500" cellspacing="80">
                                                        <thead>
                                                            <tr>
                                                                <th style="width: 50%"></th>
                                                                <th style="width: 50%"></th>
                                                        ...
                                                        <tbody>
                                                        	<tr>
                                                        		<td>
                                                        			...
                                                        			<input type="radio" class="form-field" name="tipo_aumento" id="radio_provd" value="proveedor" checked/>
                                                        		</td>
                                                        		<td>
                                                        			<label class="form-label">Por marca</label>
                                                        			<input type="radio" class="form-field" name="tipo_aumento" id="radio_marca" value="marca"/>
                                                        		</td>
                                                        	</tr>
                                                        	<tr>
                                                        		<td>
                                                        			<label class="form-label required" id="cmb_label_aumento"></label>
                                                                     <select id="cmb_aumento_marca" name="cmb_aumento_marca" class="form-field width60" style="display: none">
                                                                        <?php foreach($arr_marca as $Marca){?>
                                                                    	<option value="<?php echo $Marca->get_id_marca()?>"><?php echo $Marca->get_nom_marca()?></option>
                                                                    	<?php } ?>
                                                                    </select> 
                                                                    
                                                                    <select id="cmb_aumento_provd" name="cmb_aumento_provd" class="form-field width60">
                                                        	...
                                                        	<tr>
                                                        		<td>
	                                                        		<label class="form-label required"> Aumento (en porcentaje)</label>
                                             						<input id="txt_porcentaje_aumento" class="form-field width20" name="txt_porcentaje_aumento" type="text" value="0.00" maxlength="4"/>
                                                        		</td>
                                                        	</tr>
	                                                       	<tr>
                                                        		<td>
	                                                        		<label id="label_productos_afectados" style="font-color:red"></label>
                                                        		</td>
                                                        		<p>
                                                        	</tr>
                                                        </tody>
                                            		...
                                            		<hr/>
                                                    <input id="btn_aumento_accept" class="button themed" type="submit" value="Aceptar" name="btn_aumento_accept" />
                                            	</form>
                                            </div>
                                		</div>
