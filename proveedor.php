...
<!--        <link type="text/css" rel="stylesheet" href="CSS_INTERNO/csspantalla.css" />-->
        ...
        <script type="text/javascript" src="new_js/Persona.js" ></script>
                                                  ...
                                                  <table   width="820" cellspacing="80">
                                                        ...
                                                        <tbody>                                                           
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <label class="form-label required"> Razón Social </label>
                                                                         <input id="update_nom_persona" class="form-field width90" name="update_nom_persona" type="text" value="" maxlength="100"/>
                                                                    </td>    
                                                                </tr>                                                         
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <label class="form-label required"> ID CLIENTE </label>
                                                                         <input id="update_id_cliente" class="form-field width40" name="update_id_cliente" type="text" value="" maxlength="50"/>
                                                                    </td>
                                                                </tr>   
                                                                <tr >
                                                                    <td colspan="2">
                                            ...
                                            <div id="tabs-2">
                                                ...
                                                <div id="tabs-3">
                                                     <form id="frmProveedor_Buscar_Delete" method="post" action="">
														...
														<input id="btn_Proveedor_Buscar_Delete" class="button themed" type="submit" value="Buscar" name="btn_Proveedor_Buscar_Delete" />
                                                     </form>
