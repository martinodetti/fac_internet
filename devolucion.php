...
<script type="text/javascript" src="JS/jquery-1.6.2.min.js" ></script>
        ...
        <script type="text/javascript" src="MYJS/Devolucion.js" ></script>
...
<!--                            <li class="s_1"></li>-->
                            <li><a class="breadcrumb underline" href="#">Home -> Devolución de Venta</a></li>
                            ...
                            <div id="content" >
                                ...
                                <div class="column full fl">
                                    <div class="box tabs themed_box">
                                        <h2 class="box-header">DEVOLUCIÓN DE VENTA </h2>
                                          <ul class="tabs-nav">
				                ...
				                <a id="dial_msg_close" class="button themed closer">Aceptar</a>
                                            ...
                                            <div id="tabs-1">
                                                  <label clas="form-label required">Búsqueda de Código de Factura</label><br/>
                                                 <input id="cmbgridFactura" name="cmbgridFactura"   />
                                                <form id="frm_factura">
                                                    
                                                    <input type="hidden" id="save_id_factcmp_devo" name="save_id_factcmp_devo" value="" />
                                                    <input type="hidden" id="save_tipo_cmpbt_devo" name="save_tipo_cmpbt_devo" value="3" />
                                                    <input type="hidden" id="save_descto_devo" name="save_descto_devo" value="" />
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                       <label class="form-label required"> RUC :</label>  
                                                                        <input id="txt_ruc_fact" class="form-field width60" 
                                                                               name="txt_ruc_fact" readonly="true" type="text" value="" maxlength="130"/>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2">
                                                             ...
                                                             <tbody>
                                                                 <tr>
                                                                     ...
                                                                     <td>
                                                                        ...
                                                                        name="txt_precio" type="text" readonly="true" value="" maxlength="6"/>
                                                                     </td>
                                                                     <td>
                                                 ...
                                                 <select id="cmbDescto" name="cmbDescto" class="form-field width20">
