                                    ...
                                    <div class="box-content">
                                        ...
                                        <div id="tabs-1">
											<form id="frm_recibo">
													...
													<tbody>
														<tr>
															<td colspam=2>
																<label class="form-label required">
																	<input type="checkbox" id="save_recibo_local" name="save_recibo_local">
																	<b>Recibo local</b>
																</label>
																<br>
															</td>
														...
														<tr>
															<td>
																...
																&nbsp;
																<a href="#" style="color:red" id="link_ultimas">Últimas 10</a>
															</td>
														</tr>
														<tr>
															<td>
												...
												<input type="hidden" id="save_id_recibo" name="save_id_recibo" value="0"/>
												<input type="hidden" id="save_total_recibo" name="save_total_recibo" value="0"/>
                                                <input type="hidden" id="save_saldo_para_proveedor" name="save_saldo_para_proveedor" value="0"/>
												<input type="hidden" id="save_total_cheque" name="save_total_cheque" value="0"/>
												<input type="hidden" id="save_total_proveedor" name="save_total_proveedor" value="0"/>
                                            ...
                                            <table border=0 width="750px">
                                            	<tr>
													...
													<td>
														<table id="ttc" class="easyui-datagrid" style="width:300px;height:100px" fitColumns="true" singleSelect="true" showFooter="false" rownumbers="false" title="Cheques <a style='color:blue;' id='link_nuevoCheque' href='#'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NUEVO CHEQUE</a>" >
						                                    <thead>
																<tr>
														...
														<br>
														<table id="ttr" class="easyui-datagrid" style="width:300px;height:100px" fitColumns="true" singleSelect="true" showFooter="false" rownumbers="false" title="Retenciones <a style='color:blue;' id='link_nuevaRetencion' href='#'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NUEVA RETENCION</a>" >
						                                    <thead>
																<tr>
														...
														<table id="ttp" class="easyui-datagrid" style="width:300px;height:100px" fitColumns="true" singleSelect="true" showFooter="false" rownumbers="false" title="Facturas Proveedor <a style='color:blue;' id='link_nuevoFacturaProveedor' href='#'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NUEVA Fx. A PAGAR</a>" >
						                                    <thead>
																<tr>
																	<th field="id" width="30">ID</th>
																	<th field="tipo_num" width="80">Número</th>
																	<th field="fecha" width="100">Fecha</th>
																	<th field="total" width="70">A Pagar</th>
																	<th field="check" width="20"></th>
																</tr>
															</thead>
														</table>
														<table>
															<tr>
																<td width="200px"></th>
																<td width="100px">TOTAL: $<spam id="total_proveedor"></spam></th>
															</tr>
														</table>
											...
											<input id="btn_Recibo_Open" class="fr button themed" type="button" value="Re-abrir Recibo" name="btn_Recibo_Open"/>
										</div>
