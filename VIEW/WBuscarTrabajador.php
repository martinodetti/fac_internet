<?php
	...
	$aColumns = array( 'id_persona', 'nom_persona', 'ape_persona','ruc_persona','cel_persona','email_persona','estado_persona' );
	...
	if ( $_GET['sSearch'] != "" )
	{
		...
		$sWhere .= ')'." AND id_tipoper=1";
	}else{
         $sWhere = " WHERE id_tipoper=1 ";   
        }
	...
	$sQuery = "
		...
		FROM   $sTable WHERE id_tipoper=1";
