<?php
	 ...
	 */
	$sWhere = "WHERE pvp1_producto <= (costo_producto*1.35) and pvp1_producto > 0  and tipo = 'comerciable' and chequeado = false";
	if ( $_GET['sSearch'] != "" )
	{
		$sWhere .= "AND (";
		...
		$sWhere .= ')'." AND estado_producto='1 and tipo = 'comerciable''";
	}else{
         $sWhere = " WHERE estado_producto='1' AND pvp1_producto <= (costo_producto*1.35) and tipo = 'comerciable' and pvp1_producto > 0  and chequeado = false";
        }
	...
	$sQuery = "
		...
		FROM   $sTable WHERE pvp1_producto <= (costo_producto*1.35) and pvp1_producto > 0 AND estado_producto='1' and tipo = 'comerciable' and chequeado = false";
