<?php
	 ...
	 */
	$sWhere = "WHERE tipo = 'comerciable' and pvp1_producto = 0 ";
	if ( $_GET['sSearch'] != "" )
	{
		$sWhere .= "AND (";
		...
		$sWhere .= ')'." AND estado_producto='1' and tipo = 'comerciable'";
         ...
         $sWhere = " WHERE estado_producto='1' AND pvp1_producto = 0 and tipo = 'comerciable'";   
        }
	...
	$sQuery = "
		...
		FROM   $sTable WHERE pvp1_producto = 0 AND estado_producto='1' and tipo = 'comerciable' ";
