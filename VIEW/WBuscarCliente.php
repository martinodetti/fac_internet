<?php
	...
	$aColumns = array( 'id_persona', 'nom_persona', 'ape_persona','ruc_persona','cel_persona','email_persona','estado_persona', 'telf_persona', 'telf_persona_2', 'tiene_ctacte' );
	...
	if ( $_GET['sSearch'] != "" )
	{
		...
		$sWhere .= ')'." AND id_tipoper=2";
	}else{
         $sWhere = " WHERE id_tipoper=2 ";   
        }
	...
	$sQuery = "
		...
		FROM   $sTable WHERE id_tipoper=2";
