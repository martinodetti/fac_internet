...
<!--
											<div id="dialg_cliente_update" class="dialog" title="SYSFACTURA INFORMA">
													...
													<tbody>
														<tr>
															<td>
																...
																<input id="txt_ver_nombres" class="form-field width90" disabled="true" name="txt_ver_nombres" type="text" value="" maxlength="100"/>
															</td>
															<td>
																<label class="form-label required"> RUC </label>
																<input id="txt_ver_ruc" class="form-field width90" disabled="true" name="txt_ver_ruc" type="text" value="" maxlength="100"/>
															</td>
														</tr>
														<tr>
															<td>
																<label class="form-label required"> Teléfono </label>
																<input id="txt_ver_telefono" class="form-field width90" disabled="true" name="txt_ver_telefono" type="text" value="" maxlength="100"/>
															</td>
															<td>
																<label class="form-label required"> Celular </label>
																<input id="txt_ver_celular" class="form-field width90" disabled="true" name="txt_ver_celular" type="text" value="" maxlength="100"/>
															</td>
														</tr>
														<tr>
															<td >
																<label class="form-label required"> Dirección </label>
																<input id="txt_ver_direc" class="form-field width90" disabled="true" name="txt_ver_direc" type="text" value="" maxlength="100"/>
															</td>
															<td>
																<label class="form-label required"> Trabajador </label>
																<input id="txt_ver_trabajador" class="form-field width90" disabled="true" name="txt_ver_trabajador" type="text" value="" maxlength="100"/>
															</td>
														</tr>
													</tbody>
												</table>
                                                ...
                                                <form id="form_detalle_cliente" method="post">
														...
														<tbody>
															<tr>
																<td>
                                                                    ...
                                                                    <input id="txt_ver_ip" class="form-field width90"  name="txt_ver_ip" type="text" value="" maxlength="100"/>
                                                                </td>
																<td>
													...
													<input id="btn_ver_cancel" class="button themed" type="button" value="Cancelar" name="btn_ver_cancel" />
													<input id="btn_ver_update" class="button themed" type="button" value="Guardar" name="btn_ver_update" />
