...
if(isset ($_SESSION['id_persona'])){
	...
	$arr_mecanico	= $persona->listMecanicos();
?>
...
-->
        ...
        <script type="text/javascript" src="MYJS/Orden.js" ></script>
...
<!--                            <li class="s_1"></li>-->
                            <li><a class="breadcrumb underline" href="#">Home -> Orden de reparación</a></li>
                    ...
                    <div class="contentLayout">
                        <div id="content" >
                            <div class="column full fl">
                                ...
                                <h2 class="box-header">ORDEN DE REPARACION </h2>
                               		<ul class="tabs-nav">
...
<!--
						                        ...
						                        <input id="patente_vozcliente" class="form-field width20" name="patente_vozcliente" type="text" value="" maxlength="100"/>
-->						                                 
                                                <label class="form-label required"> Descripcion </label>
										...
										<div id="dialg_form" class="dialog" title="SYSFACTURA INFORMA">   
											<div id="tabla_result">
												 <table id="table_detalle_orden_popup" cellpadding="0" cellspacing="0" border="0" class="display" >
													<thead>
														<tr>
															<th>ID</th>
															<th>Codigo</th>
										...
										<div id="dialg_presup" class="dialog" title="SYSFACTURA INFORMA">
											<div id="div_presupuestos" name="div_presupuestos">
												<table id="presupuestos_table" class="easyui-datagrid" style="width:350px;height:auto" fitColumns="TRUE" title="Presupuestos"  singleSelect="true" showFooter="true" rownumbers="true" >
                                                    <thead>
                                                        <tr>
                                                            <th field="id" width="50">ID</th>
                                                            <th field="fecha" width="100">Fecha</th>
                                                            <th field="dominio" width="80">Vehiculo</th>
                                                            <th field="total" width="60">Total</th>
                                                        </tr>
                                                    </thead>
													<tbody>
...
<!--											<input id="btn_Detalle_Ver" class="button themed" type="button" value="Detalle" name="btn_Detalle_Ver" /> -->
											<input id="btn_Presupuesto_Importar" class="button themed" type="button" value="Importar" name="btn_Presupuesto_Importar" />
											<input id="btn_Presupuesto_cerrar" class="button themed" type="button" value="Cerrar" name="btn_Presupuesto_Cerrar" />
											</p>
											...
											<form id="frm_orden">	
												<table border="0" width="800" >
													...
													<tbody>
														<tr>
															<td>
																<label class="form-label required"> Número de orden de reparación</label>  
																<input id="txt_num_orden" readonly="true"  class="form-field width40" name="save_num_orden" type="text" value="" maxlength="15"/>
															</td>
															<td></td>
															<td>
																<label class="form-label required">Responsable de ejecución</label>  
																<select id="save_id_responsable" name="save_id_responsable" class="form-field width60">
                                                                  	<option value="0"></option>
                                                                    <?php foreach($arr_mecanico as $meca){?>
                                                                  	<option value="<?php echo $meca->get_id_persona()?>"><?php echo $meca->get_nom_persona() . " " . $meca->get_ape_persona?></option>
                                                                  	<?php } ?>
                                                            	</select> 
															</td>
														</tr>	
														<tr>
															<td>
																...
																<input id="save_fecemi_orden" class="form-field datepicker" name="save_fecemi_orden" type="text"  />
															</td>
															<td>
																<label class="form-label required"> Fecha de ingreso</label>  
																<input id="save_fecingreso_orden" class="form-field datepicker" name="save_fecingreso_orden" type="text"/>
															</td>
															<td>
																<label class="form-label required"> Fecha de egreso</label>  
																<input id="save_fecegreso_orden" class="form-field datepicker" name="save_fecegreso_orden" type="text"  />
															</td>
															<td></td>
														</tr>
...
-->                                            
												...
												<input type="hidden" id="save_total_orden" name="save_total_orden" value="" />
												...
												<table border="0" width="800" >
													...
													<tbody>
														<tr>
															<td >
																<label class="form-label required"> Observaciones :</label>  
																<input id="save_obs_orden" class="form-field width80" name="save_obs_orden" type="text" value="" maxlength="190"/>
															</td>
															<td >
...
-->
		                                                    ...
		                                                    <td >
		                                                    	<input id="btn_importarPresu" class="button themed" type="button" value="Importar presupuesto" name="btn_importarPresu" />
		                                                    </td>
														</tr>
													</tbody>
                                            	</table>
...
-->
											...
											<table id="tt" class="easyui-datagrid" style="width:700px;height:400px" fitColumns="true" title="Detalle de la orden de reparación"  singleSelect="true" showFooter="true" rownumbers="true" >
                                                <thead>
													<tr>
											...
											<hr/>
											<input id="btn_Orden_Add" class="fr button themed" type="button" value="Guardar Orden" name="btn_Orden_Add" />
											<input id="btn_Orden_Close" class="fr button themed" type="button" value="Cerrar Orden" name="btn_Orden_Add" />
											<input id="btn_Orden_Anular" class="fr button themed" type="button" value="Anular Orden" name="btn_Orden_Anular" />
											<input id="btn_Orden_New" class="fl button themed" type="button" value="Nuevo" name="btn_Orden_New" />
											<input id="btn_Orden_Print" class="fl button themed" type="button" value="Imprimir Orden" name="btn_Orden_Print" />
											<input id="btn_Orden_Print1" class="fl button themed" type="button" value="Imprimir Orden con precios" name="btn_Orden_Print1" />
<!--											<input id="btn_vozcliente_Print" class="fl button themed" type="button" value="Imprimir Voz de cliente" name="btn_vozcliente_Print" />-->
											<input id="btn_Orden_Generar" class="fr button themed" type="button" value="Generar Presup" name="btn_Orden_Generar" />
											<input id="btn_Orden_Open" class="fr button themed" type="button" value="Re-abrir Orden" name="btn_Orden_Open"/>
										</div>
